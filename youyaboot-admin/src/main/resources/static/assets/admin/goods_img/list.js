    ...
    var COLS = [[
        {type: "checkbox", /*fixed:"left",*/ width:50},//全选
            ...
            {field: 'imgSrc', title: '图片地址', minWidth:200,templet:function (d) {
                    return '<input type="text" value="'+ mc_util.escapeHTML(d.imgSrc) +'" class="magicalcoder-table-text layui-input security_list_table_form_imgSrc" name="imgSrc" data-identify="'+d.imgId+'" lay-verify="magicalCoderVerify" magicalcoder-verify="|minLength=0"  placeholder="图片地址"/>'
                }
                , sort:true
            },
                ...
                {field: 'goodsId', title: '所属商品', align:'center', minWidth:250, templet:function (d) {
                    ...
                    return '<select class="magicalcoder-table-foreign-select2 layui-input security_list_table_form_goodsId" lay-ignore="true"  name="goodsId" data-identify="'+d.imgId+'" data-value="'+value+'" data-url="admin/goods_rest/search" data-id="id" data-text-fields="goodsName" lay-verify="magicalCoderVerify" magicalcoder-verify="|minLength=0"  placeholder="所属商品"  data-limit="20"></select>'
                    },sort:true
                },
