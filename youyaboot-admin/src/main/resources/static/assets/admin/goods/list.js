...
// 子表 排序相关
    var CONFIG = {
        ...
        childrenPage:[//子页面的一些基础信息 更多信息
            {
                tabTitle:"商品图集",
                url:"admin/page_v2/goods_img/list",
                mcForeignName:"goodsId"
            },            {
                tabTitle:"商品附件",
                url:"admin/page_v2/goods_file/list",
                mcForeignName:"goodsId"
            }        ],
        ...
        //排序跟数据库实际字段名的映射
        sortMap:{
            id:'id',goodsName:'goods_name',publishStatus:'publish_status',goodsStatus:'goods_status',price:'price',storeCount:'store_count',createTime:'create_time',goodsCategoryId:'goods_category_id'
        }
    };
    //后端请求时候的表模块规则url
    ...
    var COLS = [[
        {type: "checkbox", /*fixed:"left",*/ width:50},//全选
            ...
            {field: 'goodsName', title: '商品名', minWidth:200,templet:function (d) {
                    return '<input type="text" value="'+ mc_util.escapeHTML(d.goodsName) +'" class="magicalcoder-table-text layui-input security_list_table_form_goodsName" name="goodsName" data-identify="'+d.id+'" lay-verify="magicalCoderVerify|mc_required" magicalcoder-verify="|minLength=0"  placeholder="请输入商品名"/>'
                }
                , sort:true
            },
            {field: 'createTime', title: '创建时间', align:'center', minWidth:250, templet :"#createTimeTemplate",sort:true},
                ...
                {field: 'publishStatus', title: '是否发布',minWidth:150, align:'center', templet:function(d){
                    ...
                    return '<input type="checkbox" class="magicalcoder-table-layswitch security_list_table_form_publishStatus" data-identify="'+d.id+'" name="publishStatus"  lay-filter="publishStatusFilter" lay-skin="switch" lay-text="启用|禁用"  '+checked+' lay-verify="magicalCoderVerify" magicalcoder-verify="|minLength=0" />'
                    }
                    ,sort:true
                },
            ...
            {field: 'price', title: '价格', minWidth:200,templet:function (d) {
                    return '<input type="text" value="'+ mc_util.escapeHTML(d.price) +'" class="magicalcoder-table-text layui-input security_list_table_form_price" name="price" data-identify="'+d.id+'" lay-verify="magicalCoderVerify|mc_required|mc_number" magicalcoder-verify="|minLength=0"  placeholder="请输入价格"/>'
                }
                , sort:true
            },

            {field: 'storeCount', title: '库存', minWidth:200,templet:function (d) {
                    return '<input type="text" value="'+ mc_util.escapeHTML(d.storeCount) +'" class="magicalcoder-table-text layui-input security_list_table_form_storeCount" name="storeCount" data-identify="'+d.id+'" lay-verify="magicalCoderVerify|mc_required|mc_number" magicalcoder-verify="|minLength=0"  placeholder="请输入库存"/>'
                }
                , sort:true
            },
                {field: 'goodsCategoryId', title: '商品分类', align:'center', minWidth:250, templet:function (d) {
