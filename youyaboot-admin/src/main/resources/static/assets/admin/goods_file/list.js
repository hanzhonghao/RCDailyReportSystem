...
// 子表 排序相关
    var CONFIG = {
        ...
        //排序跟数据库实际字段名的映射
        sortMap:{
            fileId:'file_id',fileSrc:'file_src'
        }
    };
    //后端请求时候的表模块规则url
    ...
    var COLS = [[
        {type: "checkbox", /*fixed:"left",*/ width:50},//全选
            ...
            {field: 'fileSrc', title: '文件地址', minWidth:200,templet:function (d) {
                    return '<input type="text" value="'+ mc_util.escapeHTML(d.fileSrc) +'" class="magicalcoder-table-text layui-input security_list_table_form_fileSrc" name="fileSrc" data-identify="'+d.fileId+'" lay-verify="magicalCoderVerify" magicalcoder-verify="|minLength=0"  placeholder="文件地址"/>'
                }
                , sort:true
            },
