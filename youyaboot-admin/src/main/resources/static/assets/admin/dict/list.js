    ...
    var COLS = [[
        {type: "checkbox", /*fixed:"left",*/ width:50},//全选
            ...
            {field: 'code', title: '编码', minWidth:200,templet:function (d) {
                    return '<input type="text" value="'+ mc_util.escapeHTML(d.code) +'" class="magicalcoder-table-text layui-input security_list_table_form_code" name="code" data-identify="'+d.id+'" lay-verify="magicalCoderVerify|mc_required" magicalcoder-verify="|minLength=0"  placeholder="编码"/>'
                }
                , sort:true
            },
                {field: 'parentId', title: '所属父类', align:'center', minWidth:250, templet:function (d) {
                    ...
                    return '<select class="magicalcoder-table-foreign-select2 layui-input security_list_table_form_parentId" lay-ignore="true"  name="parentId" data-identify="'+d.id+'" data-value="'+value+'" data-url="admin/dict_rest/search" data-id="id" data-text-fields="code" lay-verify="magicalCoderVerify" magicalcoder-verify="|minLength=0"  placeholder="所属父类"  data-limit="20"></select>'
                    },sort:true
                },

            {field: 'name', title: '名称', minWidth:200,templet:function (d) {
                    return '<input type="text" value="'+ mc_util.escapeHTML(d.name) +'" class="magicalcoder-table-text layui-input security_list_table_form_name" name="name" data-identify="'+d.id+'" lay-verify="magicalCoderVerify|mc_required" magicalcoder-verify="|minLength=0"  placeholder="名称"/>'
                }
                , sort:true
            },
            ...
            {field: 'dictCategory', title: '字典大类', minWidth:200,templet:function (d) {
                    return '<input type="text" value="'+ mc_util.escapeHTML(d.dictCategory) +'" class="magicalcoder-table-text layui-input security_list_table_form_dictCategory" name="dictCategory" data-identify="'+d.id+'" lay-verify="magicalCoderVerify|mc_required" magicalcoder-verify="|minLength=0"  placeholder="字典大类"/>'
                }
                , sort:true
            },

            {field: 'createTime', title: '创建时间', minWidth:200,templet:function (d) {
                    return '<input type="text" value="'+ mc_util.escapeHTML(d.createTime) +'" class="magicalcoder-table-text layui-input security_list_table_form_createTime" name="createTime" data-identify="'+d.id+'" lay-verify="magicalCoderVerify|mc_required" magicalcoder-verify="|minLength=0"  placeholder="创建时间"/>'
                }
                , sort:true
            },

            {field: 'updateTime', title: '更新时间', minWidth:200,templet:function (d) {
                    return '<input type="text" value="'+ mc_util.escapeHTML(d.updateTime) +'" class="magicalcoder-table-text layui-input security_list_table_form_updateTime" name="updateTime" data-identify="'+d.id+'" lay-verify="magicalCoderVerify|mc_required" magicalcoder-verify="|minLength=0"  placeholder="更新时间"/>'
                }
                , sort:true
            },
